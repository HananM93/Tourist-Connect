...
class GuidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guide" do
    assert_difference("Guide.count") do
      post guides_url, params: { guide: { location: @guide.location, name: @guide.name, rate: @guide.rate } }
    end
  ...
  test "should update guide" do
    patch guide_url(@guide), params: { guide: { location: @guide.location, name: @guide.name, rate: @guide.rate } }
